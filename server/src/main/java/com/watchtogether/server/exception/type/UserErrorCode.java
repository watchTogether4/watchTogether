...
public enum UserErrorCode {
    ...
    LEAVE_USER(HttpStatus.BAD_REQUEST, "탈퇴한 사용자입니다."),
    NEED_VERIFY_EMAIL(HttpStatus.BAD_REQUEST, "이메일 인증을 완료해주세요."),
    ...
    WRONG_PASSWORD_USER(HttpStatus.BAD_REQUEST, "패스워드가 일치하지 않습니다.");
