    ...
    >
      <Wrapper direction='column' justifyContent='flex-start'>
        <SelectSection direction='column' justifyContent='flex-start'>
          <Leader direction='column' justifyContent='flex-start'
          role={role} onClick={()=> handleLeader()}>
            <RoleTitle>
              파티장
            </RoleTitle>
            <TextBox>
          ...
          <Follower direction="column" justifyContent="flex-start"
          role={role} onClick={()=> handleFollower()}>
            <RoleTitle>
              파티원
            </RoleTitle>
            <TextBox>
